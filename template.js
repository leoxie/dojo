define(["dojo/_base/json"], function(JSON) {
	...
	(function(exports, global) {
		...
		exports.tpl = function(id, source, debug, notSkipCache) {
		...
		exports.tplRender = function(source, data) {
			if (source === "") return "";
			var cache = exports.compile(source);
			return cache(data);
		};
		...
		// 模板编译器
		var _compile = (function() { // 辅助方法集合
			exports.prototype = {
				//$render: exports.render,
				$render: exports.tplRender,
			...
			// 关键字
			"\\b" + keyWords.replace(/,/g, '\\b|\\b') + "\\b"].join('|'), 'g');
			// 提取js源码中所有变量
			...
			return function(source, isDebug) {
				...
				var include = "function(id,data){" + "if(data===undefined){data=$data}" + "var content=$helpers.$render(id,data);" + concat + "}"; // html与逻辑语法分离
